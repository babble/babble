...
tests=[
    ...
    { name: "autoescape-tag02", content: "{% autoescape off %}{{ first }}{% endautoescape %}", model: { "first": "<b>hello</b>" }, results: "<b>hello</b>" },
    ...
    { name: "autoescape-tag06", content: "{{ first }}", model: { "first": djang10.mark_safe("<b>first</b>") }, results: "<b>first</b>" },
    { name: "autoescape-tag07", content: "{% autoescape on %}{{ first }}{% endautoescape %}", model: { "first": djang10.mark_safe("<b>Apple</b>") }, results: "<b>Apple</b>" },
    ...
    { name: "basic-syntax09", content: "{{ var_ex.method }}", model: { "var_ex": new SomeClass() }, results: "SomeClass.method" },
    { name: "basic-syntax10", content: "{{ var_ex.otherclass.method }}", model: { "var_ex": new SomeClass() }, results: "OtherClass.method" },
    { name: "basic-syntax11", content: "{{ var_ex.blech }}", model: { "var_ex": new SomeClass() }, results: [ "", "INVALID" ] },
    { name: "basic-syntax12", content: "{{ var_ex.__dict__ }}", model: { "var_ex": new SomeClass() }, results: TemplateSyntaxError },
    { name: "basic-syntax13", content: "{{ va>r }}", model: {  }, results: TemplateSyntaxError },
    { name: "basic-syntax14", content: "{{ (var_ex.r) }}", model: {  }, results: TemplateSyntaxError },
    ...
    { name: "basic-syntax20", content: "{{ var_ex.method2 }}", model: { "var_ex": new SomeClass() }, results: [ "", "INVALID" ] },
    ...
    { name: "filter-syntax01", content: "{{ var_ex|upper }}", model: { "var_ex": "Django is the greatest!" }, results: "DJANGO IS THE GREATEST!" },
    { name: "filter-syntax02", content: "{{ var_ex|upper|lower }}", model: { "var_ex": "Django is the greatest!" }, results: "django is the greatest!" },
    { name: "filter-syntax03", content: "{{ var_ex |upper }}", model: {  }, results: TemplateSyntaxError },
    { name: "filter-syntax04", content: "{{ var_ex| upper }}", model: {  }, results: TemplateSyntaxError },
    { name: "filter-syntax05", content: "{{ var_ex|does_not_exist }}", model: {  }, results: TemplateSyntaxError },
    { name: "filter-syntax06", content: "{{ var_ex|fil(ter) }}", model: {  }, results: TemplateSyntaxError },
    ...
    { name: "filter-syntax09", content: "{{ var_ex|removetags:\"b i\"|upper|lower }}", model: { "var_ex": "<b><i>Yes</i></b>" }, results: "yes" },
    { name: "filter-syntax10", content: "{{ var_ex|default_if_none:\" endquote\\\" hah\" }}", model: { "var_ex": null }, results: " endquote\" hah" },
    { name: "filter-syntax11", content: "{{ var_ex|default_if_none:var2 }}", model: { "var_ex": null, "var2": "happy" }, results: "happy" },
    { name: "filter-syntax12", content: "{{ var_ex|yesno:\"yup,nup,mup\" }} {{ var_ex|yesno }}", model: { "var_ex": 1 }, results: "yup yes" },
    { name: "filter-syntax13", content: "1{{ var_ex.method3 }}2", model: { "var_ex": new SomeClass() }, results: [ "12", "1INVALID2" ] },
    { name: "filter-syntax14", content: "1{{ var_ex.method4 }}2", model: { "var_ex": new SomeClass() }, results: SomeOtherException },
    { name: "filter-syntax15", content: "{{ var_ex|default_if_none:\"foo\\bar\" }}", model: { "var_ex": null }, results: "foo\\bar" },
    { name: "filter-syntax16", content: "{{ var_ex|default_if_none:\"foo\\now\" }}", model: { "var_ex": null }, results: "foo\\now" },
    { name: "filter-syntax17", content: "{{ var_ex|join:\"\" }}", model: { "var_ex": [ "a", "b", "c" ] }, results: "abc" },
    { name: "filter-syntax19", content: "{{ var_ex|truncatewords:1 }}", model: { "var_ex": "hello world" }, results: "hello ..." },
    ...
    { name: "for-tag-unpack01", content: "{% for key,value in items %}{{ key }}:{{ value }}/{% endfor %}", model: { "items": [ [ "one", 1 ], [ "two", 2 ] ] }, results: "one:1/two:2/" },
    { name: "for-tag-unpack03", content: "{% for key, value in items %}{{ key }}:{{ value }}/{% endfor %}", model: { "items": [ [ "one", 1 ], [ "two", 2 ] ] }, results: "one:1/two:2/" },
    { name: "for-tag-unpack04", content: "{% for key , value in items %}{{ key }}:{{ value }}/{% endfor %}", model: { "items": [ [ "one", 1 ], [ "two", 2 ] ] }, results: "one:1/two:2/" },
    { name: "for-tag-unpack05", content: "{% for key ,value in items %}{{ key }}:{{ value }}/{% endfor %}", model: { "items": [ [ "one", 1 ], [ "two", 2 ] ] }, results: "one:1/two:2/" },
    { name: "for-tag-unpack06", content: "{% for key value in items %}{{ key }}:{{ value }}/{% endfor %}", model: { "items": [ [ "one", 1 ], [ "two", 2 ] ] }, results: TemplateSyntaxError },
    { name: "for-tag-unpack07", content: "{% for key,,value in items %}{{ key }}:{{ value }}/{% endfor %}", model: { "items": [ [ "one", 1 ], [ "two", 2 ] ] }, results: TemplateSyntaxError },
    { name: "for-tag-unpack08", content: "{% for key,value, in items %}{{ key }}:{{ value }}/{% endfor %}", model: { "items": [ [ "one", 1 ], [ "two", 2 ] ] }, results: TemplateSyntaxError },
    { name: "for-tag-unpack09", content: "{% for val in items %}{{ val.0 }}:{{ val.1 }}/{% endfor %}", model: { "items": [ [ "one", 1 ], [ "two", 2 ] ] }, results: "one:1/two:2/" },
    { name: "for-tag-unpack10", content: "{% for x,y in items %}{{ x }}:{{ y }}/{% endfor %}", model: { "items": [ [ "one", 1, "carrot" ], [ "two", 2, "orange" ] ] }, results: "one:1/two:2/" },
    { name: "for-tag-unpack11", content: "{% for x,y,z in items %}{{ x }}:{{ y }},{{ z }}/{% endfor %}", model: { "items": [ [ "one", 1 ], [ "two", 2 ] ] }, results: [ "one:1,/two:2,/", "one:1,INVALID/two:2,INVALID/" ] },
    { name: "for-tag-unpack12", content: "{% for x,y,z in items %}{{ x }}:{{ y }},{{ z }}/{% endfor %}", model: { "items": [ [ "one", 1, "carrot" ], [ "two", 2 ] ] }, results: [ "one:1,carrot/two:2,/", "one:1,carrot/two:2,INVALID/" ] },
    { name: "for-tag-unpack13", content: "{% for x,y,z in items %}{{ x }}:{{ y }},{{ z }}/{% endfor %}", model: { "items": [ [ "one", 1, "carrot" ], [ "two", 2, "cheese" ] ] }, results: [ "one:1,carrot/two:2,cheese/", "one:1,carrot/two:2,cheese/" ] },
    ...
    { name: "ifequal-numeric04", content: "{% ifequal x 5.2 %}yes{% endifequal %}", model: { "x": 5.200000 }, results: "yes" },
    { name: "ifequal-numeric05", content: "{% ifequal x 0.2 %}yes{% endifequal %}", model: { "x": 0.200000 }, results: "yes" },
    { name: "ifequal-numeric06", content: "{% ifequal x .2 %}yes{% endifequal %}", model: { "x": 0.200000 }, results: "yes" },
    ...
    { name: "ifequal-numeric11", content: "{% ifequal x -5.2 %}yes{% endifequal %}", model: { "x": -5.200000 }, results: "yes" },
    ...
    { name: "inheritance20", content: "{% extends 'inheritance01' %}{% block first %}{{ block.super_ }}a{% endblock %}", model: {  }, results: "1&a3_" },
    { name: "inheritance21", content: "{% extends 'inheritance02' %}{% block first %}{{ block.super_ }}a{% endblock %}", model: {  }, results: "12a34" },
    { name: "inheritance22", content: "{% extends 'inheritance04' %}{% block first %}{{ block.super_ }}a{% endblock %}", model: {  }, results: "1&a3_" },
    { name: "inheritance23", content: "{% extends 'inheritance20' %}{% block first %}{{ block.super_ }}b{% endblock %}", model: {  }, results: "1&ab3_" },
    ...
    { name: "invalidstr01", content: "{{ var_ex|default:\"Foo\" }}", model: {  }, results: [ "Foo", "INVALID" ] },
    { name: "invalidstr02", content: "{{ var_ex|default_if_none:\"Foo\" }}", model: {  }, results: [ "", "INVALID" ] },
    { name: "invalidstr03", content: "{% for v in var_ex %}({{ v }}){% endfor %}", model: {  }, results: "" },
    { name: "invalidstr04", content: "{% if var_ex|default:\"Foo\" %}Yes{% else %}No{% endif %}", model: {  }, results: "Yes" },
    { name: "invalidstr05", content: "{{ var_ex }}", model: {  }, results: [ "", "INVALID %s", "var" ] },
    { name: "invalidstr06", content: "{{ var_ex.prop }}", model: { "var_ex": {  } }, results: [ "", "INVALID %s", "var.prop" ] },
    { name: "list-index01", content: "{{ var_ex.1 }}", model: { "var_ex": [ "first item", "second item" ] }, results: "second item" },
    { name: "list-index02", content: "{{ var_ex.5 }}", model: { "var_ex": [ "first item", "second item" ] }, results: [ "", "INVALID" ] },
    { name: "list-index03", content: "{{ var_ex.1 }}", model: { "var_ex": null }, results: [ "", "INVALID" ] },
    { name: "list-index04", content: "{{ var_ex.1 }}", model: { "var_ex": {  } }, results: [ "", "INVALID" ] },
    { name: "list-index05", content: "{{ var_ex.1 }}", model: { "var_ex": { "1": "hello" } }, results: "hello" },
    { name: "list-index06", content: "{{ var_ex.1 }}", model: { "var_ex": { 1: "hello" } }, results: "hello" },
    { name: "list-index07", content: "{{ var_ex.1 }}", model: { "var_ex": { "1": "hello", 1: "world" } }, results: "hello" },
