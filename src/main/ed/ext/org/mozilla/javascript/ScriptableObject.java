...
import java.io.*;
import ed.ext.org.mozilla.javascript.debug.DebuggableObject;
                                                  ...
                                                  ConstProperties
{
     ...
     *
     * @see ed.ext.org.mozilla.javascript.ScriptableObject#getAttributes(String)
     * @see ed.ext.org.mozilla.javascript.ScriptableObject#setAttributes(String, int)
     */
     ...
     *
     * @see ed.ext.org.mozilla.javascript.ScriptableObject#getIds()
     * @see ed.ext.org.mozilla.javascript.ScriptableObject#getAttributes(String)
     * @see ed.ext.org.mozilla.javascript.ScriptableObject#setAttributes(String, int)
     */
     ...
     *
     * @see ed.ext.org.mozilla.javascript.ScriptableObject#delete(String)
     * @see ed.ext.org.mozilla.javascript.ScriptableObject#getAttributes(String)
     * @see ed.ext.org.mozilla.javascript.ScriptableObject#setAttributes(String, int)
     */
     ...
     * @see ed.ext.org.mozilla.javascript.ScriptableObject#has(String, Scriptable)
     * @see ed.ext.org.mozilla.javascript.ScriptableObject#READONLY
     * @see ed.ext.org.mozilla.javascript.ScriptableObject#DONTENUM
     * @see ed.ext.org.mozilla.javascript.ScriptableObject#PERMANENT
     * @see ed.ext.org.mozilla.javascript.ScriptableObject#EMPTY
     */
     ...
     * @see ed.ext.org.mozilla.javascript.Function
     * @see ed.ext.org.mozilla.javascript.FunctionObject
     * @see ed.ext.org.mozilla.javascript.ScriptableObject#READONLY
     * @see ed.ext.org.mozilla.javascript.ScriptableObject
