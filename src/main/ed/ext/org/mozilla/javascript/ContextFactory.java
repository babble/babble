...
public class ContextFactory
{
    ...
    /**
     * Provides a default
     * {@link ed.ext.org.mozilla.javascript.xml.XMLLib.Factory XMLLib.Factory}
     ...
     */
    protected ed.ext.org.mozilla.javascript.xml.XMLLib.Factory
        getE4xImplementationFactory()
    {
        ...
        if (isDom3Present()) {
            return ed.ext.org.mozilla.javascript.xml.XMLLib.Factory.create(
                "ed.ext.org.mozilla.javascript.xmlimpl.XMLLibImpl"
            );
        } else if (Kit.classOrNull("org.apache.xmlbeans.XmlCursor") != null) {
            return ed.ext.org.mozilla.javascript.xml.XMLLib.Factory.create(
                "ed.ext.org.mozilla.javascript.xml.impl.xmlbeans.XMLLibImpl"
            );
        } else {
            return null;
        }
