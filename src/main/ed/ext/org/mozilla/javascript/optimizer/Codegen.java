...
import ed.ext.org.mozilla.classfile.*;
import java.util.*;
...
public class Codegen extends Interpreter
{
                          ...
                          boolean returnFunction)
    {
        ...
        String mainClassName = "ed.ext.org.mozilla.javascript.gen.c"+serial;
    ...
    private byte[] generateCode(String encodedSource)
    {
        ...
        if (hasScript) {
            cfw.addInterface("ed.ext.org.mozilla.javascript/Script");
...
*/
        ...
        cfw.addInvoke(ByteCode.INVOKEVIRTUAL,
                      "ed.ext.org.mozilla.javascript/BaseFunction",
                      "createObject",
                      "(Led.ext.org.mozilla.javascript/Context;"
                      +"Led.ext.org.mozilla.javascript/Scriptable;"
                      +")Led.ext.org.mozilla.javascript/Scriptable;");
        ...
        cfw.add(ByteCode.INSTANCEOF, "ed.ext.org.mozilla.javascript/Scriptable");
        cfw.add(ByteCode.IFEQ, exitLabel);
        // cast direct call result
        cfw.add(ByteCode.CHECKCAST, "ed.ext.org.mozilla.javascript/Scriptable");
    ...
    private void generateCallMethod(ClassFileWriter cfw)
    {
        ...
        cfw.addALoad(1); //cx
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      "ed.ext.org.mozilla.javascript/ScriptRuntime",
                      "hasTopCall",
                      "(Led.ext.org.mozilla.javascript/Context;"
                      +")Z");
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      "ed.ext.org.mozilla.javascript/ScriptRuntime",
                      "doTopCall",
                      "(Led.ext.org.mozilla.javascript/Callable;"
                      +"Led.ext.org.mozilla.javascript/Context;"
                      +"Led.ext.org.mozilla.javascript/Scriptable;"
                      +"Led.ext.org.mozilla.javascript/Scriptable;"
                      +"[Ljava/lang/Object;"
    ...
    private void generateMain(ClassFileWriter cfw)
    {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      mainMethodClass,
                      "main",
                      "(Led.ext.org.mozilla.javascript/Script;[Ljava/lang/String;)V");
                                      ...
                                      OptFunctionNode ofn)
    {
        ...
        cfw.addALoad(SCOPE_ARG);
        cfw.addInvoke(ByteCode.INVOKEVIRTUAL,
                      "ed.ext.org.mozilla.javascript/NativeFunction",
                      "initScriptFunction",
                      "(Led.ext.org.mozilla.javascript/Context;"
                      +"Led.ext.org.mozilla.javascript/Scriptable;"
                      +")V");
        ...
        for (int i = 0; i != scriptOrFnNodes.length; ++i) {
            ...
            for (int j = 0; j != regCount; ++j) {
                ...
                cfw.addInvoke(ByteCode.INVOKEINTERFACE,
                              "ed.ext.org.mozilla.javascript/RegExpProxy",
                              "compileRegExp",
                              "(Led.ext.org.mozilla.javascript/Context;"
                         ...
                         int contextArg, int scopeArg)
    {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      ...
                      "checkRegExpProxy",
                      "(Led.ext.org.mozilla.javascript/Context;"
                      +")Led.ext.org.mozilla.javascript/RegExpProxy;");
        // Stack: proxy, array
        cfw.add(ByteCode.DUP);
        cfw.addALoad(contextArg);
        ...
        if (num == 0.0) {
            if (1 / num > 0) {
                ...
                cfw.add(ByteCode.GETSTATIC,
                        "ed.ext.org.mozilla.javascript/optimizer/OptRuntime",
    ...
    {
        cfw.add(ByteCode.GETSTATIC, "ed.ext.org.mozilla.javascript/Undefined",
    ...
    String getBodyMethodSignature(ScriptOrFnNode n)
    {
        ...
        sb.append("Led.ext.org.mozilla.javascript/Context;"
                  +"Led.ext.org.mozilla.javascript/Scriptable;"
                  +"Led.ext.org.mozilla.javascript/Scriptable;");
        if (n.getType() == Token.FUNCTION) {
            OptFunctionNode ofn = OptFunctionNode.get(n);
   ...
   static final String FUNCTION_CONSTRUCTOR_SIGNATURE
        = "(Led.ext.org.mozilla.javascript/Scriptable;"
          +"Led.ext.org.mozilla.javascript/Context;I)V";
...
class BodyCodegen
{
    ...
    private void generateGenerator()
    {
                ...
                || fnCurrent.fnode.getIgnoreDynamicScope()))
        {
            ...
            cfw.addInvoke(ByteCode.INVOKEINTERFACE,
                          "ed.ext.org.mozilla.javascript/Scriptable",
                          "getParentScope",
                          "()Led.ext.org.mozilla.javascript/Scriptable;");
        ...
        addScriptRuntimeInvoke("createFunctionActivation",
                               "(Led.ext.org.mozilla.javascript/NativeFunction;"
                               +"Led.ext.org.mozilla.javascript/Scriptable;"
                               +"[Ljava/lang/Object;"
                               +")Led.ext.org.mozilla.javascript/Scriptable;");
        cfw.addAStore(variableObjectLocal);
        ...
        addOptRuntimeInvoke("createNativeGenerator",
                               "(Led.ext.org.mozilla.javascript/NativeFunction;"
                               +"Led.ext.org.mozilla.javascript/Scriptable;II"        
                               +")Led.ext.org.mozilla.javascript/Scriptable;");
    ...
    private void generatePrologue()
    {
        ...
        if (compilerEnv.isGenerateDebugInfo()) {
            cfw.addVariableDescriptor(debugVariableName, "Led.ext.org.mozilla.javascript/Scriptable;", cfw.getCurrentCodeOffset(), variableObjectLocal);
        }
    ...
    private void generateActivationExit()
    {
        ...
        addScriptRuntimeInvoke("exitActivationFunction",
                               "(Led.ext.org.mozilla.javascript/Context;)V");
    }
    ...
    private void generateThrowJavaScriptException()
    {
        cfw.add(ByteCode.NEW,
                        "ed.ext.org.mozilla.javascript/JavaScriptException");
        ...
        switch (type) {
              ...
              case Token.REF_CALL:
                ...
                addScriptRuntimeInvoke(
                    ...
                    +"[Ljava/lang/Object;"
                    +"Led.ext.org.mozilla.javascript/Context;"
                    +")Led.ext.org.mozilla.javascript/Ref;");
                break;
                                  ...
                                  Node child)
    {
        ...
        if (type == Token.NEW) {
            ...
            callSignature = "(Led.ext.org.mozilla.javascript/Context;"
                            +"Ljava/lang/Object;"
                            +"[Ljava/lang/Object;"
                            +"Led.ext.org.mozilla.javascript/Scriptable;"
                            +"Led.ext.org.mozilla.javascript/Scriptable;"
    ...
    private void visitStandardCall(Node node, Node child)
    {
        ...
        if (firstArgChild == null) {
            if (childType == Token.NAME) {
                ...
                generateFunctionAndThisObj(child, node);
                methodName = "call0";
                signature = "(Led.ext.org.mozilla.javascript/Callable;"
                            +"Led.ext.org.mozilla.javascript/Scriptable;"
                            +"Led.ext.org.mozilla.javascript/Context;"
                            +"Led.ext.org.mozilla.javascript/Scriptable;"
                            +")Ljava/lang/Object;";
...
*/
        ...
        if (type == Token.NEW) {
            ...
            cfw.addInvoke(ByteCode.INVOKEINTERFACE,
                "ed.ext.org.mozilla.javascript/Callable",
                "call",
                "(Led.ext.org.mozilla.javascript/Context;"
                +"Led.ext.org.mozilla.javascript/Scriptable;"
                +"Led.ext.org.mozilla.javascript/Scriptable;"
                                    ...
                                    int exceptionLocal)
    {
        ...
        if (exceptionType == JAVASCRIPT_EXCEPTION) {
            exceptionName = "ed.ext.org.mozilla.javascript/JavaScriptException";
        } else if (exceptionType == EVALUATOR_EXCEPTION) {
            exceptionName = "ed.ext.org.mozilla.javascript/EvaluatorException";
        } else {
            if (exceptionType != ECMAERROR_EXCEPTION) Kit.codeBug();
            exceptionName = "ed.ext.org.mozilla.javascript/EcmaError";
        }
