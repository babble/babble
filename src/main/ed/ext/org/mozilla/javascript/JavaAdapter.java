...
public final class JavaAdapter implements IdFunctionCall
{
                                           ...
                                           String scriptClassName)
    {
        ClassFileWriter cfw = new ClassFileWriter(adapterName,
                                                  superClass.getName(),
                                                  "<adapter>");
        cfw.addField("factory", "Led.ext.org.mozilla.javascript/ContextFactory;",
                     (short) (ClassFileWriter.ACC_PUBLIC |
                              ClassFileWriter.ACC_FINAL));
        cfw.addField("delegee", "Led.ext.org.mozilla.javascript/Scriptable;",
                     (short) (ClassFileWriter.ACC_PUBLIC |
                              ClassFileWriter.ACC_FINAL));
        cfw.addField("self", "Led.ext.org.mozilla.javascript/Scriptable;",
                     (short) (ClassFileWriter.ACC_PUBLIC |
                              ClassFileWriter.ACC_FINAL));
                                     ...
                                     String superName)
    {
        cfw.startMethod("<init>",
                        "(Led.ext.org.mozilla.javascript/ContextFactory;"
                        +"Led.ext.org.mozilla.javascript/Scriptable;)V",
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      "ed.ext.org.mozilla.javascript/JavaAdapter",
                                          ...
                                          String scriptClassName)
    {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      "ed.ext.org.mozilla.javascript/JavaAdapter",
                      "runScript",
                      "(Led.ext.org.mozilla.javascript/Script;"
                      +")Led.ext.org.mozilla.javascript/Scriptable;");
                                     ...
                                     boolean callConvertResult)
    {
        ...
        if (retType == Void.TYPE) {
            ...
            cfw.addInvoke(ByteCode.INVOKESTATIC,
                          "ed.ext.org.mozilla.javascript/Context",
                                       ...
                                       Class returnType)
    {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      ...
                      "(Led.ext.org.mozilla.javascript/Scriptable;"
                      +"Ljava/lang/String;"
                      +")Led.ext.org.mozilla.javascript/Function;");
