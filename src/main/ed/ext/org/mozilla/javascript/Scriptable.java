 ...
 * <p>
 *
 * @see ed.ext.org.mozilla.javascript.ScriptableObject
 * @author Norris Boyd
...
public interface Scriptable {
     ...
     * <LI>ed.ext.org.mozilla.javascript.Scriptable objects</LI>
     * <LI>null</LI>
     ...
     * @see ed.ext.org.mozilla.javascript.Context#getUndefinedValue
     */
     ...
     * @see ed.ext.org.mozilla.javascript.Scriptable#get(String, Scriptable)
     * @see ed.ext.org.mozilla.javascript.ScriptableObject#getProperty(Scriptable, String)
     */
     ...
     * @see ed.ext.org.mozilla.javascript.ScriptableObject#getProperty(Scriptable, int)
     */
     ...
     * @see ed.ext.org.mozilla.javascript.Scriptable#get(String, Scriptable)
     * @see ed.ext.org.mozilla.javascript.ScriptableObject#putProperty(Scriptable, String, Object)
     * @see ed.ext.org.mozilla.javascript.Context#toObject(Object, Scriptable)
     */
     ...
     * @see ed.ext.org.mozilla.javascript.Scriptable#get(int, Scriptable)
     * @see ed.ext.org.mozilla.javascript.ScriptableObject#putProperty(Scriptable, int, Object)
     * @see ed.ext.org.mozilla.javascript.Context#toObject(Object, Scriptable)
     */
     ...
     * @see ed.ext.org.mozilla.javascript.Scriptable#get(String, Scriptable)
     * @see ed.ext.org.mozilla.javascript.ScriptableObject#deleteProperty(Scriptable, String)
     */
     ...
     * @param index the numeric index for the property
     * @see ed.ext.org.mozilla.javascript.Scriptable#get(int, Scriptable)
     * @see ed.ext.org.mozilla.javascript.ScriptableObject#deleteProperty(Scriptable, int)
     */
