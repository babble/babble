...
import ed.ext.org.mozilla.javascript.debug.Debugger;
...
public class Context
{
     ...
     *         thread.
     * @see ed.ext.org.mozilla.javascript.Context#enter()
     * @see ed.ext.org.mozilla.javascript.Context#exit()
     */
    ...
    public static void addContextListener(ContextListener listener)
    {
        ...
        String DBG = "ed.ext.org.mozilla.javascript.tools.debugger.Main";
        if (DBG.equals(listener.getClass().getName())) {
            Class cl = listener.getClass();
            Class factoryClass = Kit.classOrNull(
                "ed.ext.org.mozilla.javascript.ContextFactory");
     ...
     *
     * @see ed.ext.org.mozilla.javascript.ErrorReporter
     */
     ...
     * @see ed.ext.org.mozilla.javascript.SecurityController
     */
     ...
     * @exception IOException if an IOException was generated by the Reader
     * @see ed.ext.org.mozilla.javascript.Script
     */
    ...
    private static Class codegenClass = Kit.classOrNull(
                             "ed.ext.org.mozilla.javascript.optimizer.Codegen");
    ...
    RegExpProxy getRegExpProxy()
    {
        if (regExpProxy == null) {
            Class cl = Kit.classOrNull(
                          "ed.ext.org.mozilla.javascript.regexp.RegExpImpl");
            if (cl != null) {
