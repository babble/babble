...
This document assumes you have read the Babble and Mongo documentation.
...
"/core" or "core" then it looks in the 10gen core framework directories. If it
starts with "/external" or "external", it looks in the third party libraries
suplied by 10gen.
