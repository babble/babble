//JSFunctionCalls25.java

package ed.js.func;

import ed.js.engine.*;
import ed.js.*;
public abstract class JSFunctionCalls25 extends JSFunction { 
    public JSFunctionCalls25(){
        super( 25 );
    }

    public JSFunctionCalls25( Scope scope , String name ){
        super( scope , name , 25 );
    }
