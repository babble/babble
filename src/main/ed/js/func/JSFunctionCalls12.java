//JSFunctionCalls12.java

package ed.js.func;

import ed.js.engine.*;
import ed.js.*;
public abstract class JSFunctionCalls12 extends JSFunction { 
    public JSFunctionCalls12(){
        super( 12 );
    }

    public JSFunctionCalls12( Scope scope , String name ){
        super( scope , name , 12 );
    }
