//JSFunctionCalls21.java

package ed.js.func;

import ed.js.engine.*;
import ed.js.*;
public abstract class JSFunctionCalls21 extends JSFunction { 
    public JSFunctionCalls21(){
        super( 21 );
    }

    public JSFunctionCalls21( Scope scope , String name ){
        super( scope , name , 21 );
    }
