/* no particular redistribution rights are granted;
   ...
   exceptions: Internet Connection, Inc. customers may
   use this application on any site they like. They may
   not grant redistribution or other rights to others.
   they may do this even if they (sadly) become no longer customers.
...
function term_vi_e() {
    return term_skipforward(/[a-zA-Z0-9_][^a-zA-Z0-9_]/, 1);
}
